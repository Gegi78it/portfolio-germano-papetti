  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content={tr("Contattami per collaborazioni e progetti: rispondo rapidamente.", "Get in touch for collaborations and projects: I reply quickly.")} />
    ...
    <div className="h-full bg-primary/30">
      <div className="container mx-auto py-32 text-center xl:text-left flex items-center justify-center h-full">
        ...
        <div className="flex flex-col w-full max-w-[700px]">
          ...
          >
            {tr("Parliamo ", "Let\u2019s talk ")}<span className="text-accent">{tr("del tuo progetto.", "about your project.")}</span>
          </motion.h2>
