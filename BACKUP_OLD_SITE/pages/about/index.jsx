...
const About = () => {
  ...
  return (
    <>
      <Head>
        <title>{tr("Chi sono | Germano Papetti", "About | Germano Papetti")}</title>
        <meta name="description" content={tr("Esperienza, competenze e percorso professionale di Germano Papetti.", "Experience, skills and professional background of Germano Papetti.")} />
        <link rel="canonical" href="https://gpgraphicdesigner.com/about" />
      </Head>
      ...
      <div className="container mx-auto h-full flex flex-col items-center xl:flex-row gap-x-6">
        ...
        <div className="flex-1 flex flex-col justify-center relative z-10">
          ...
          <motion.h2
            ...
            className="h2"
          >
            {tr("Dall’editoria al ", "From editorial to ")}<span className="text-accent">{tr("digitale", "digital")}</span>:{/* */}
            <br />
            {tr("grafica, contenuti e strategie per", "design, content and strategies for")} comunicare.
          </motion.h2>
