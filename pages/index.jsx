  ...
  return (
    <>
      ...
      <div className="bg-primary/60 min-h-screen relative">
        ...
        <div className="container mx-auto min-h-screen text-center xl:text-left flex flex-col justify-center relative z-10 pt-16 pb-[320px] md:pb-[260px] xl:pb-16">
          <motion.h1
        ...
        {/* AVATAR: sempre in basso, su mobile dietro al contenuto (z-0) */}
        <div className="absolute bottom-0 left-1/2 -translate-x-1/2 z-0 w-[340px] max-w-[90vw] md:w-[420px] xl:left-auto xl:translate-x-0 xl:right-[8%] xl:w-auto xl:max-w-[737px] xl:max-h-[678px] xl:z-10 pointer-events-none">
          <Avatar />
        </div>
      </div>
    </>
