    ...
    <>
      <Head>
        ...
        <meta
          name="description"
          content={tr(
            "Esperienza, competenze e percorso professionale di Germano Papetti.",
            "Experience, skills and professional background of Germano Papetti."
          )}
        />
        ...
        <div className="container mx-auto h-full flex flex-col items-center xl:flex-row gap-x-6">
          ...
          <div className="flex-1 flex flex-col justify-center relative z-10">
            ...
            <motion.h2
              ...
              className="h2"
            >
              {tr("Dall’editoria al ", "From editorial to ")}
              <span className="text-accent">{tr("digitale", "digital")}</span>:
              <br />
              {tr(
                "grafica, contenuti e strategie per",
                "design, content and strategies for"
              )}{" "}
              comunicare.
            </motion.h2>

            {/* sottotitolo (per ora in IT) */}
            <motion.p
